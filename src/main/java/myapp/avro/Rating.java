...
public class Rating extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final Long serialVersionUID = -5073748502509741552L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Rating\",\"namespace\":\"myapp.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"rating\",\"type\":\"double\"}]}");
   ...
   */
  public static myapp.avro.Rating.Builder newBuilder() {
    return new myapp.avro.Rating.Builder();
  }
   ...
   * @return A new Rating RecordBuilder
   */
  public static myapp.avro.Rating.Builder newBuilder(myapp.avro.Rating.Builder other) {
    if (other == null) {
      return new myapp.avro.Rating.Builder();
    } else {
      return new myapp.avro.Rating.Builder(other);
    }
  }
   ...
   * @return A new Rating RecordBuilder
   */
  public static myapp.avro.Rating.Builder newBuilder(myapp.avro.Rating other) {
    if (other == null) {
      return new myapp.avro.Rating.Builder();
    } else {
      return new myapp.avro.Rating.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Rating>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(myapp.avro.Rating.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(myapp.avro.Rating other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public myapp.avro.Rating.Builder setId(Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public myapp.avro.Rating.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public myapp.avro.Rating.Builder setRating(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public myapp.avro.Rating.Builder clearRating() {

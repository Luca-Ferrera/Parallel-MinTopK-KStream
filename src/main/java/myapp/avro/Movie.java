...
public class Movie extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final Long serialVersionUID = 8447732928436448757L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Movie\",\"namespace\":\"myapp.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"title\",\"type\":\"string\"},{\"name\":\"release_year\",\"type\":\"int\"}]}");
   ...
   */
  public static myapp.avro.Movie.Builder newBuilder() {
    return new myapp.avro.Movie.Builder();
  }
   ...
   * @return A new Movie RecordBuilder
   */
  public static myapp.avro.Movie.Builder newBuilder(myapp.avro.Movie.Builder other) {
    if (other == null) {
      return new myapp.avro.Movie.Builder();
    } else {
      return new myapp.avro.Movie.Builder(other);
    }
  }
   ...
   * @return A new Movie RecordBuilder
   */
  public static myapp.avro.Movie.Builder newBuilder(myapp.avro.Movie other) {
    if (other == null) {
      return new myapp.avro.Movie.Builder();
    } else {
      return new myapp.avro.Movie.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Movie>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(myapp.avro.Movie.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(myapp.avro.Movie other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public myapp.avro.Movie.Builder setId(Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public myapp.avro.Movie.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public myapp.avro.Movie.Builder setTitle(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public myapp.avro.Movie.Builder clearTitle() {
      title = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public myapp.avro.Movie.Builder setReleaseYear(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public myapp.avro.Movie.Builder clearReleaseYear() {

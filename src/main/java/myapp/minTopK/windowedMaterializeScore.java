...
public class windowedMaterializeScore {
    public Properties buildStreamsProperties(Properties envProps) {
        Properties props = new Properties();

        props.put(StreamsConfig.APPLICATION_ID_CONFIG, envProps.getProperty("wms.id"));
    ...
    public static void main(String[] args) throws Exception {
        ...
        windowedMaterializeScore wms = new windowedMaterializeScore();
        Properties envProps = wms.loadEnvProperties(args[0]);
        Properties streamProps = wms.buildStreamsProperties(envProps);
        Topology topology = wms.buildTopology(envProps);
        System.out.println(topology.describe());

        wms.createTopics(envProps);
